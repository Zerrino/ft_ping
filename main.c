...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 12:49:05 by alexafer          #+#    #+#             */
/*   Updated: 2025/10/24 18:57:09 by alexafer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	getsockname(sd, (struct sockaddr *)&src, &len);
  ...
  // Source IPv4 address (32 bits)
	...
	if (recvfrom(sd, (void *)pkt, IP4_HDRLEN + ICMP_HDRLEN+datalen, 0, 0, (socklen_t*)sizeof(struct sockaddr)) < 0)
	{
